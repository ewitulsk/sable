...
$files = @('Cargo.toml','src/dynamics/rigid_body_set.rs','src/geometry/collider_set.rs','src/geometry/narrow_phase.rs','src/geometry/broad_phase_bvh.rs') | ForEach-Object { @{path=$_;sha256=(Get-FileHash -LiteralPath (Join-Path $generated $_)).Hash} }
