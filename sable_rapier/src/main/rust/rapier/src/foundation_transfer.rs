...
pub(super) fn dispatch(registry:&mut Registry,scene:i64,op:i32,ids:&[i64],values:&[f64])->Result<Vec<i64>,String> {
    ...
    if preview::retains(registry,scene)&&!matches!(op,0|3|7|8|11|13|20|22|30|35|40|42|44|49|50|56|57|58|74|76|77|79|83|84|90){return Err("staged interval retains native scene mutations".into());}
    ...
    match op {
        ...
        40..=49 | 57 | 58 | 74..=79 | 81..=84 => controlled::dispatch(registry,scene,op,ids,values),
